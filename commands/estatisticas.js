...
///////////////////////
        ...
        .addField(`Hoje:`, `Pedidos: \`${hojepedidos || "0"}\`\nRecebimentos: \`R$${hojerecebimentos || "0"}\``, true)
        .addField(`Ultimos 7 dias:`, `Pedidos: \`${setedias || "0"}\`\nRecebimentos: \`R$${setediasrec || "0"}\``, true)
        .addField(`Ultimos 30 dias:`, `Pedidos: \`${setedias2 || "0"}\`\nRecebimentos: \`R$${setediasrec2 || "0"}\``, true)
        .addField(`Todo Periodo:`, `**Pedidos:** \`${db2.get(`pedidostotal`) || "0"}\` | **Recebimentos:** \`R$${db2.get(`gastostotal`) || "0"}\``)
        .setColor(config.cor)
